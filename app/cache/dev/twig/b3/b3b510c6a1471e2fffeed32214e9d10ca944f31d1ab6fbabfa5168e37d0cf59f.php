...
/* FTTAdminBundle:Profil:consulterProfil.html.twig */
class __TwigTemplate_13f14b79c2cbc58651fc44d2fd5babc1a0f90b464d7f0b36b6d750aecd4936a0 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("FTTAdminBundle::layoutAdmin.html.twig", "FTTAdminBundle:Profil:consulterProfil.html.twig", 2);
        $this->blocks = array(
    ...
    public function block_bodyAdmin($context, array $blocks = array())
    {
        ...
        echo "</h3>
                        ...
                        <ul class=\"list-unstyled user_data\">
                            ...
                            <li>
                                <i class=\"fa fa-briefcase user-profile-icon\"></i> Departement : ";
        // line 86
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "departementAdmin", array()), "html", null, true);
        echo "
                            </li>
        ...
        echo "\" class=\"btn btn-success\"><i class=\"fa fa-key\" aria-hidden=\"true\"></i>
                        ...
                        <a href=\"";
        // line 94
        echo $this->env->getExtension('routing')->getPath("modifier_profil_admin");
...
";
    ...
    {
        return "FTTAdminBundle:Profil:consulterProfil.html.twig";
    }
...
/*                                     <div class="modal-dialog modal-lg">*/
/*                                         <div class="modal-content">*/
/*                                             <form enctype="multipart/form-data" action="{{path('consulter_profil_admin')}}" method="POST" >*/
/*                                                 <div class="modal-header">*/
/*                                                     <button class="close" data-dismiss="modal" type="button">&times;</button>*/
/*                                                     <h4 class="modal-title" id="avatar-modal-label">Change Avatar</h4>*/
/*                                                 </div>*/
...
/* */
/*                             <li>*/
/*                                 <i class="fa fa-briefcase user-profile-icon"></i> Departement : {{app.user.departementAdmin}}*/
/*                             </li>*/
/* */
/* */
/*                         </ul>*/
...
/*                             Modifier Mot de passe</a>*/
/*                         <a href="{{path('modifier_profil_admin')}}" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Modifier Profile</a>*/
/*                         <br />*/
/* */
/* */
/* */
