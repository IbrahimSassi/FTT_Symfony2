...
/* FTTAdminBundle:Archive:archiveMatch.html.twig */
class __TwigTemplate_6cf9004ddffac14d10efa5453448066b1ac83a4b1533b5a8d2eee2478af6120a extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("FTTAdminBundle::layoutAdmin.html.twig", "FTTAdminBundle:Archive:archiveMatch.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_bodyAdmin($context, array $blocks = array())
    {
        // line 6
        echo "           
       <div class=\"container\"style=\"width:800px;height: 1800px;\">
    <div class=\"row\">
      
        <div class=\"col-md-4\" style=\"width:800px;height: 1800px;\">
            <div class=\"panel panel-success\">
                <div class=\"panel-heading\">
                      <p class=\"lead\">
                        <strong>Les Matchs</strong></p>
...
\t\t</section>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["match"]) {
            ...
            echo "<i class=\"fa fa-male\"></i> </strong>
                            <h4 class=\"brief\"><i> Arbitre : ";
            // line 53
            ...
            echo " </i></h4>
                            <h4 class=\"brief\"><i class=\"fa fa-map\"> Stade : ";
            // line 54
            ...
            echo "</i> &nbsp;&nbsp;&nbsp;<i class=\"fa fa-hourglass-start\"> Date : ";
...
<script>if (typeof jQuery !== \"undefined\" && typeof saveAs !== \"undefined\") {
    (function(\$) {
        \$.fn.wordExport = function(fileName) {
            fileName = typeof fileName !== 'undefined' ? fileName : \"FTT Matchs\";
            var static = {
                mhtml: {
...
<br/><br/><br/><br/><br/><br/>
    ...
    {
        return "FTTAdminBundle:Archive:archiveMatch.html.twig";
    }
    ...
    {
        return array (  121 => 61,  108 => 56,  101 => 54,  95 => 53,  89 => 52,  81 => 49,  77 => 47,  73 => 46,  31 => 6,  28 => 5,  11 => 1,);
    }
}
...
/*                        */
/*                  <i class="fa fa-arrows"></i> <strong>*/
/*                                     {{match.idJoueur2.nomJoueur}} {{match.idJoueur2.prenomJoueur}}<i class="fa fa-male"></i> </strong>*/
/*                             <h4 class="brief"><i> Arbitre : {{match.idArbitre.nomUser}} {{match.idArbitre.prenomUser}} </i></h4>*/
/*                             <h4 class="brief"><i class="fa fa-map"> Stade : {{match.idStade.NomStade}}</i> &nbsp;&nbsp;&nbsp;<i class="fa fa-hourglass-start"> Date : {{match.dateMatch|date('d-m-Y')}}</i> </i></h4>*/
/* */
/*                             <h4  class="brief"><i>Evenement :  {{match.idEvenement.nomEvenement}} &nbsp;&nbsp;&nbsp;Type Match : {{match.typeMatch}} </i></h4>*/
/*                    </legend>*/
/*                         </fieldset>*/
/*                         */
/*                         {% endfor %}*/
