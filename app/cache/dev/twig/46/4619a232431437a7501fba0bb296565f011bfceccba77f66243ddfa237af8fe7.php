...
/* FTTMedecinBundle:Profil:consulterProfil.html.twig */
class __TwigTemplate_ea64f3cd0bb82cc0e3d1c417f14efbd70db9b1f0916b23609a6d4576dbc3ba7b extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("FTTMedecinBundle::layoutMedecin.html.twig", "FTTMedecinBundle:Profil:consulterProfil.html.twig", 1);
        $this->blocks = array(
    ...
    public function block_bodyAdmin($context, array $blocks = array())
    {
        ...
        echo "</h3>
                        ...
                        <ul class=\"list-unstyled user_data\">
                            ...
                            <li>
                                <i class=\"fa fa-briefcase user-profile-icon\"></i> Specialite : ";
        // line 90
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "specialiteMedecin", array()), "html", null, true);
        echo "
                            </li>
                        </ul>
                        <a href=\"";
        ...
        echo "\" class=\"btn btn-success\"><i class=\"fa fa-key\" aria-hidden=\"true\"></i>
                        ...
                        <a href=\"";
        // line 95
        echo $this->env->getExtension('routing')->getPath("modifier_profil_medecin");
...
";
    ...
    {
        return "FTTMedecinBundle:Profil:consulterProfil.html.twig";
    }
    ...
    {
        return array (  256 => 183,  240 => 170,  221 => 154,  210 => 146,  199 => 138,  188 => 130,  177 => 122,  147 => 95,  142 => 93,  136 => 90,  124 => 83,  80 => 42,  67 => 32,  58 => 26,  42 => 12,  39 => 11,  32 => 6,  29 => 5,  11 => 1,);
    }
}
...
/*                                     <div class="modal-dialog modal-lg">*/
/*                                         <div class="modal-content">*/
/*                                             <form enctype="multipart/form-data" action="{{path('consulter_profil_medecin')}}" method="POST" >*/
/*                                                 <div class="modal-header">*/
/*                                                     <button class="close" data-dismiss="modal" type="button">&times;</button>*/
/*                                                     <h4 class="modal-title" id="avatar-modal-label">Change Avatar</h4>*/
/*                                                 </div>*/
...
/*                             </li>*/
/*                             <li>*/
/*                                 <i class="fa fa-briefcase user-profile-icon"></i> Specialite : {{app.user.specialiteMedecin}}*/
/*                             </li>*/
/*                         </ul>*/
/*                         <a href="{{path('fos_user_change_password')}}" class="btn btn-success"><i class="fa fa-key" aria-hidden="true"></i>*/
/*                             Modifier Mot de passe</a>*/
/*                         <a href="{{path('modifier_profil_medecin')}}" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Modifier Profile</a>*/
/*                         <br />*/
/* */
/* */
/* */
