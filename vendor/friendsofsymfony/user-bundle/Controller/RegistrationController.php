...
class RegistrationController extends Controller {
    ...
    public function registerAction(Request $request) {
        ...
        $CUser = $this->container->get('security.context')->getToken()->getUser();

        if (is_object($CUser)) {
            return $this->redirect($this->generateUrl('ftt_utilisateur_error_not_found'));
        }
        ...
        if ($form->isValid()) {
            ...
            // $user->setImmatricule($user->getPlainPassword());
