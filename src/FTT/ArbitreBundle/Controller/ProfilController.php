...
class ProfilController extends Controller {
    ...
    public function ProfilAction() {
        ...
        if ($Form->isSubmitted()) {
            ...
            $em->persist($user);
            $em->flush();
            return $this->redirect($this->generateUrl('consulter_profil_arbitre'));
        }

        return $this->render("FTTArbitreBundle:Profil:consulterProfil.html.twig", array(
            "images" => $images,"ProfilPic" => $images,
    ...
    public function EditProfilAction() {
        ...
        $image = base64_encode(stream_get_contents($userCo->getImageUser()));
        ...
        return $this->render("FTTArbitreBundle:Profil:ModifierProfil.html.twig", 
