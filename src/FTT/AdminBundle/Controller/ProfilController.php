...
class ProfilController extends Controller {
    ...
    public function ProfilAction() {
        ...
        if ($Form->isSubmitted()) {
            ...
            $em->persist($user);
            $em->flush();
            return $this->redirect($this->generateUrl('consulter_profil_admin'));
        }

        return $this->render("FTTAdminBundle:Profil:consulterProfil.html.twig", array(
    ...
    public function EditProfilAction() {
        ...
        return $this->render("FTTAdminBundle:Profil:ModifierProfil.html.twig", array('Form' => $Form->createView()));
    }
