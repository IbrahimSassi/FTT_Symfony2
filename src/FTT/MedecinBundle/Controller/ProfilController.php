...
class ProfilController extends Controller {
    ...
    public function ProfilAction() {
        ...
        if ($Form->isSubmitted()) {
            ...
            $em->persist($user);
            $em->flush();
            return $this->redirect($this->generateUrl('consulter_profil_medecin'));
        }

        return $this->render("FTTMedecinBundle:Profil:consulterProfil.html.twig", array(
                    "images" => $images,
                    "ProfilPic" => $images,
    ...
    public function EditProfilAction() {
        ...
        return $this->render("FTTMedecinBundle:Profil:ModifierProfil.html.twig", array('Form' => $Form->createView()
                    , "ProfilPic" => $images
        ));
    }
