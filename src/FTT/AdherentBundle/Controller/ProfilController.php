...
class ProfilController extends Controller {
    ...
    public function ProfilAction() {
        ...
        if ($Form->isSubmitted()) {
            ...
            $em->persist($user);
            $em->flush();
            return $this->redirect($this->generateUrl('consulter_profil_adherent'));
        }
    ...
    public function EditProfilAction() {
        ...
        return $this->render("FTTAdherentBundle:Profil:ModifierProfil.html.twig", array('Form' => $Form->createView()));
    }
